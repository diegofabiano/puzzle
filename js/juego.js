...
var instrucciones = ["Utilizá las flechas del teclado para mover las piezas", "Usá tu ingenio y lógica para formar la imágen combinando correctamente las partes de ésta."];
...
function UltimoMovimiento(direccion) {
  ...
  actualizarUltimoMovimiento(UltimoMovimiento, "flecha");
}
...
var largo = grilla.length; //siempre 3
var largoW = grillaWin.length; //siempre 3
